...
public class PushMessageController {
	 ...
	 * @param msg
	 */
	@RequestMapping("/sendWebToApp")
	public void sendWebToAppMsg(String message) {
		//TODO 消息处理
		//不同类型的业务消息不同的处理逻辑 work-order-queue
		//message.getType()  推送给具体的队列
		amqpTemplate.convertAndSend(RabbitConfig.TO_WEB_QUEUE_NAME, message+"-----"+UUID.randomUUID());
	}
